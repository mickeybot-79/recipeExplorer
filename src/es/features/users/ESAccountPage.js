            ...
            <>
                <div id="edit-user-container">
                    <div id="account-container">
                        ...
                        <p className="account-option" onClick={handleUpdatePwd}>Cambiar contraseña ➜</p>
                        <p className="account-option" id="delete-page" onClick={handleUpdateDelete}>Eliminar Cuenta <span style={{ fontSize: '18px' }}>✖</span></p>
                    </div>
                </div>
                {/* image */}
                <div className="update-field-container" style={{ display: fieldToEdit.image }}>
                    <div className="account-content-container" style={{ animation: currentAnimation }}>
                        ...
                        <p id="account-image-prompt">Selecciona un avatar:</p>
                        ...
                        <div id="account-image">
                            <label className="account-image-input">O sube una foto de perfil:</label>
                            <input
                                type="file"
                                onChange={(e) => {
                                    handleNewPicture(e)
                        ...
                        <div className="account-buttons-container">
                            <button type="button" onClick={handleUpdateImage} className="account-cancel-button">Cancelar</button>
                            <button type="button" className="account-save-button" onClick={handleSaveNewPicture}>Guardar cambios</button>
                        </div>
                    </div>
                </div>
                {/* country */}
                <div className="update-field-container" style={{ display: fieldToEdit.country }}>
                    <div className="account-content-container" style={{ animation: currentAnimation }}>
                        ...
                        <label id="account-country-prompt">Seleccionar nuevo país:</label>
                        <select
                            id='account-country'
                        ...
                        <div className="account-buttons-container">
                            <button type="button" onClick={handleUpdateCountry} className="account-cancel-button">Cancelar</button>
                            <button type="button" className="account-save-button" onClick={handleSaveNewCountry}>Guardar cambios</button>
                        </div>
                    </div>
                </div>
                {/* about */}
                <div className="update-field-container" style={{ display: fieldToEdit.about }}>
                    <div className="account-content-container" style={{ animation: currentAnimation }}>
                        <div id="account-about-container">
                            <label className="new-user-form-input">Tu introducción:</label>
                            <textarea
                        ...
                        <div className="account-buttons-container">
                            <button type="button" onClick={handleUpdateAbout} className="account-cancel-button">Cancelar</button>
                            <button type="button" className="account-save-button" onClick={handleSaveNewIntro}>Guardar cambios</button>
                        </div>
                    </div>
                </div>
                {/* pwd */}
                    ...
                    <div className="account-content-container" style={{ animation: currentAnimation }}>
                        <div id="account-password-container">
                            <div id="account-enter-password">
                                <label htmlFor="password" className="account-password-label">Escribe una nueva contraseña:</label>
                                <input
                            ...
                            <div id="account-password-confirm">
                                <label htmlFor="confirm-password" className="account-password-label">Confirmar contraseña:</label>
                                <input
                                    className="account-input"
                                    type="password"
                            ...
                            <div id="pwd-mismatch-container">
                                <p id="mismatch-label" style={{ display: pwdMismatch }}>Las contraseñas no coinciden</p>
                            </div>
                        </div>
                        <div className="account-buttons-container">
                            <button type="button" onClick={handleUpdatePwd} className="account-cancel-button">Cancelar</button>
                            <button type="button" className="account-save-button" onClick={handleSaveNewPwd}>Guardar cambios</button>
                        </div>
                    </div>
                </div>
                {/* delete */}
                <div className="update-field-container" style={{ display: fieldToEdit.delete }}>
                    <div className="account-content-container" style={{ animation: currentAnimation }}>
                        <p id="account-delete-prompt">¿Estás seguro de que deseas eliminar tu cuenta?</p>
                        <div className="account-buttons-container">
                            <button type="button" onClick={handleUpdateDelete} className="account-cancel-button">Cancelar</button>
                            <button type="button" className="account-save-button" onClick={handleDisplayDelete}>Eliminar cuenta</button>
                        </div>
                    </div>
                </div>
                <div id="account-delete-container" style={{display: displayDelete}}>
                    <div id='account-confirm-delete'>
                        ...
                        <div id='account-confirm-delete-buttons'>
                            ...
                            <button type='button' id='do-delete' onClick={handleDeleteAccount}>Eliminar</button>
                        </div>
                    </div>
                </div>
